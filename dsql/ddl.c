...
put_number (request, isc_dyn_system_flag, frb_sysflag_check_constraint);
...
put_number (request, isc_dyn_system_flag, frb_sysflag_referential_constraint);
...
put_number (request, isc_dyn_system_flag, frb_sysflag_view_check);
...
switch (user->nod_type)
    ...
    case nod_user_name:
		if (user->nod_count == 2)
			put_cstring (request, isc_dyn_grant_user_explicit, name->str_data);
		else
