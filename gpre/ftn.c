...
#ifdef DARWIN
#define INCLUDE_ISC_FTN  "       INCLUDE  '/System/Library/Frameworks/Firebird.framework/Headers/gds.f\' \n\n"
...

static void gen_database_decls (
    ACT		action)
{
/**************************************
 *
