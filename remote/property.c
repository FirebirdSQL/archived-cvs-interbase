/*************  history ************
*
*       COMPONENT: REMOTE       MODULE: PROPERTY.C
*       generated by Marion V2.5     2/6/90
*       from dev              db        on 1-FEB-1996
*****************************************************************
*
*       20959   RCURRY  1-FEB-1996
*       Add missing break before case WM_HELP
*
*       20950   RMIDEKE 31-JAN-1996
*       add whats this
*
*       20909   RCURRY  24-JAN-1996
*       Move HelpCmd() from here to ibconfig.c
*
*       20903   RCURRY  24-JAN-1996
*       Add a nice little help button for confused users
*
*       20861   jmayer  17-JAN-1996
*       Restore code that was removed by previous change.
*
*       0       JKONERU 5-JAN-1996 
*       history begins
*
