...
set MINOR_VER=0
set REV_NO=0
set BUILD_SUFFIX="Firebird Release Candidate 1"
...
set WIN_FILE_VER_NUMBER=%WIN_MAJOR_VER%, %WIN_MINOR_VER%, %REV_NO%, %THISBUILD%
...
echo #define WIN_FB_MAJOR_VER "%WIN_MAJOR_VER%" >> jrd/build_no.h
echo #define WIN_FB_MINOR_VER "%WIN_MINOR_VER%" >> jrd/build_no.h
