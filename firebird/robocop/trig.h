                  ...
                  blr_begin,
					...
					blr_for,
						blr_rse, 4,
							...
							blr_relation, 13, 'R','D','B','$','R','E','L','A','T','I','O','N','S', 7,
							blr_boolean,
								blr_and,
									blr_eql,
										blr_field, 4, 14, 'R','D','B','$','I','N','D','E','X','_','N','A','M','E',
														...
														blr_not,
															blr_or,
																...
																blr_eql,
																	blr_upcase,
																		blr_user_name,
																	blr_field, 7, 14, 'R','D','B','$','O','W','N','E','R','_','N','A','M','E',
							blr_end,
						blr_begin,
							blr_leave, 2,
							blr_end,
					blr_if,
						blr_any,
							blr_rse, 1,
								blr_relation, 24, 'R','D','B','$','R','E','L','A','T','I','O','N','_','C','O','N','S','T','R','A','I','N','T','S', 8,
								blr_boolean,
									blr_and,
										blr_eql,
											blr_field, 8, 14, 'R','D','B','$','I','N','D','E','X','_','N','A','M','E',
											blr_field, 0, 14, 'R','D','B','$','I','N','D','E','X','_','N','A','M','E',
										blr_eql,
											blr_field, 8, 19, 'R','D','B','$','C','O','N','S','T','R','A','I','N','T','_','T','Y','P','E',
											blr_literal, blr_text, 11,0, 'P','R','I','M','A','R','Y',32,'K','E','Y',
								blr_end,
						blr_begin,
							blr_if,
