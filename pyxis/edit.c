...
static char
   isc_1 [] = {
   1,4,0,8,0,8,0,8,0,7,0,7,0,7,0,7,0,7,0,40,1,0,8,2,6,'H','E','I',
   'G','H','T',0,0,5,0,2,5,'W','I','D','T','H',1,0,6,0,2,12,'O',
   'U','T','L','I','N','E','_','F','O','R','M',7,0,4,0,5,3,0,-1
...
static char
   isc_13 [] = {
   1,4,0,2,0,7,0,40,31,0,9,2,9,'F','O','R','M','_','N','A','M',
   'E',1,0,0,0,-1
...
static char
   isc_18 [] = {
   1,6,2,17,'R',101,118,101,114,115,101,32,111,112,116,105,111,
   110,115,58,32,3,1,6,'I','N','V','E','R','T',3,2,17,'R','E','V',
   'E','R','S','E',32,'O','N',32,'U','P','D','A','T','E',3,3,6,
...
static char
   isc_19 [] = {
   1,6,2,14,'M',111,118,101,32,111,112,116,105,111,110,115,58,32,
   3,1,4,'I','T','E','M',3,2,4,'S','O','M','E',3,3,4,'M','O','S',
...
static char
   isc_21 [] = {
   1,4,0,22,0,40,32,0,40,8,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,0,7,
   0,7,0,7,0,7,0,7,0,7,0,7,0,40,31,0,40,31,0,40,-1,0,40,1,0,40,
   1,0,8,2,8,'D','A','T','A','T','Y','P','E',1,0,13,0,2,5,'S','C',
   'A','L','E',8,0,7,0,2,6,'L','E','N','G','T','H',10,0,9,0,2,5,
   'W','I','D','T','H',12,0,11,0,2,10,'F','I','E','L','D','_','N',
   'A','M','E',17,0,16,0,2,11,'E','D','I','T','_','S','T','R','I',
   'N','G',18,0,15,0,2,11,'F','I','L','L','_','S','T','R','I','N',
   'G',19,0,14,0,2,6,'U','P','C','A','S','E',20,0,6,0,2,11,'A',
   'L','I','G','N','_','R','I','G','H','T',21,0,5,0,5,3,0,6,0,0,
   -1
...
static char
   isc_46 [] = {
   1,6,2,8,'C',104,97,110,103,101,58,32,3,1,15,'C','H','A','R',
   'A','C','T','E','R','I','S','T','I','C','S',3,2,12,'E','N','U',
   'M','E','R','A','T','I','O','N','S',3,3,4,'E','X','I','T',-1
   
   };   /* end of blr string for request isc_46 */

static isc_req_handle
   isc_47 = 0;          /* request handle */

static short
   isc_48l = 28;
static char
   isc_48 [] = {
   1,4,0,2,0,7,0,40,31,0,9,2,10,'F','I','E','L','D','_','N','A',
   'M','E',1,0,0,0,-1
...
static char
   isc_53 [] = {
   1,6,2,8,'C',104,97,110,103,101,58,32,3,1,15,'C','H','A','R',
   'A','C','T','E','R','I','S','T','I','C','S',3,2,6,'R','E','G',
   'I','O','N',3,3,8,'S','U','B',45,'I','T','E','M',3,4,4,'S','I',
   'Z','E',3,5,4,'E',120,105,116,-1
   };   /* end of blr string for request isc_53 */

static isc_req_handle
   isc_54 = 0;          /* request handle */

static short
   isc_55l = 31;
static char
   isc_55 [] = {
   1,4,0,4,0,45,0,0,7,0,7,0,7,0,8,2,6,'V','A','L','U','E','S',0,
   0,3,0,5,2,0,-1
...
static char
   isc_62 [] = {
   1,6,2,13,'A',100,100,32,111,112,116,105,111,110,115,58,32,3,
   1,4,'T','E','X','T',3,2,5,'F','I','E','L','D',3,3,15,'D','A',
   'T','A','B','A','S','E',32,'F','I','E','L','D','S',3,4,18,'R',
   'E','P','E','A','T','I','N','G',32,'S','U','B',45,'F','O','R',
...
static char
   isc_63 [] = {
   1,6,2,14,'E',100,105,116,32,111,112,116,105,111,110,115,58,32,
   3,1,6,'S','E','L','E','C','T',3,2,4,'M','O','V','E',3,3,3,'A',
   'D','D',3,4,6,'C','H','A','N','G','E',3,5,6,'D','E','L','E',
   'T','E',3,6,7,'R','E','V','E','R','S','E',3,7,4,'S','A','V',
...
for (attribute = NULL;;)
    ...
    switch (c)
        ...
        default:
            ...
            switch (isc_menu ((long*) 0L, &isc_window, &MENU1, &isc_63l, isc_63))
               {
...
{
   if (!ENUMERATION)
      isc_load_form ((long*) 0L, &db, &gds__trans, &ENUMERATION, (short*) 0, "ENUMERATIONS");
   if (!isc_54)
      isc_compile_map ((long*) 0L, &ENUMERATION, &isc_54, &isc_55l, isc_55);
   isc_reset_form ((long*) 0L, &isc_54);
    ...
    isc_57.isc_59 = 0;
    isc_57.isc_61 = 2;
    isc_drive_form ((long*) 0L, &db, &gds__trans, &isc_window, &isc_54, &isc_57, &isc_57);
    };
    if (/*X.TERMINATOR*/
    ...
    switch (isc_menu ((long*) 0L, &isc_window, &MENU3, &isc_53l, isc_53))
       {
        ...
        case 1:
            ...
            {
               if (!NAME_PROMPT)
                  isc_load_form ((long*) 0L, &db, &gds__trans, &NAME_PROMPT, (short*) 0, "FIELD_NAME");
               if (!isc_47)
                  isc_compile_map ((long*) 0L, &NAME_PROMPT, &isc_47, &isc_48l, isc_48);
               isc_reset_form ((long*) 0L, &isc_47);
                ...
                {
                isc_50.isc_51 = 7;
                isc_drive_form ((long*) 0L, &db, &gds__trans, &isc_window, &isc_47, &isc_50, &isc_50);
                };
                if (/*F.FIELD_NAME.STATE*/
                    isc_50.isc_51 == PYXIS__OPT_USER_DATA)
...
{
   if (!FIELD_EDIT)
      isc_load_form ((long*) 0L, &db, &gds__trans, &FIELD_EDIT, (short*) 0, "FIELD_EDIT");
   if (!isc_20)
      isc_compile_map ((long*) 0L, &FIELD_EDIT, &isc_20, &isc_21l, isc_21);
   isc_reset_form ((long*) 0L, &isc_20);
    ...
    strcpy (/*X.ALIGN_RIGHT*/
            isc_23.isc_45, (GET_VALUE (field, att_insert_right)) ? "Y" : "N");
    ...
    for (;;)
        ...
        if (dtype->dtyp_length)
            ...
            /*X.LENGTH.STATE*/
            isc_23.isc_33 = PYXIS__OPT_DISPLAY;
            }
        else
            /*X.LENGTH.STATE*/
            isc_23.isc_33 = PYXIS__OPT_UPDATE | PYXIS__OPT_DISPLAY;
        ...
        switch (dtype->dtyp_internal)
            ...
            case dtype_quad:
                /*X.SCALE.STATE*/
                isc_23.isc_31 = PYXIS__OPT_DISPLAY | PYXIS__OPT_UPDATE;
                break;
        ...
        isc_23.isc_39 = 3;
        isc_23.isc_40 = 3;
        isc_drive_form ((long*) 0L, &db, &gds__trans, &isc_window, &isc_20, &isc_23, &isc_23);
        };
        for (dtype = dtypes; dtype->dtyp_string; dtype++)
        ...
        if (/*X.FIELD_NAME.STATE*/
            isc_23.isc_40 == PYXIS__OPT_USER_DATA) fnam_upd = TRUE;
        if (/*X.EDIT_STRING.STATE*/
            isc_23.isc_39 == PYXIS__OPT_USER_DATA) edstr_upd = TRUE;
        if (/*X.FILL_STRING.STATE*/
            isc_23.isc_38 == PYXIS__OPT_USER_DATA) fstr_upd = TRUE;
        if (/*X.SCALE.STATE*/
            isc_23.isc_31 == PYXIS__OPT_USER_DATA) scale_upd = TRUE;
        if (/*X.WIDTH.STATE*/
            isc_23.isc_35 == PYXIS__OPT_USER_DATA) w_upd = TRUE;
...
{
   if (!NAME_PROMPT)
      isc_load_form ((long*) 0L, &db, &gds__trans, &NAME_PROMPT, (short*) 0, "FORM_NAME");
   if (!isc_12)
      isc_compile_map ((long*) 0L, &NAME_PROMPT, &isc_12, &isc_13l, isc_13);
   isc_reset_form ((long*) 0L, &isc_12);
    for (;;)
        ...
        {
        isc_15.isc_16 = 6;
        isc_drive_form ((long*) 0L, &db, &gds__trans, &isc_window, &isc_12, &isc_15, &isc_15);
        };
        if (/*F.FORM_NAME.STATE*/
            isc_15.isc_16 != PYXIS__OPT_USER_DATA ||
...
{
   if (!RESIZE_FORM)
      isc_load_form ((long*) 0L, &db, &gds__trans, &RESIZE_FORM, (short*) 0, "SIZE_FORM");
   if (!isc_0)
      isc_compile_map ((long*) 0L, &RESIZE_FORM, &isc_0, &isc_1l, isc_1);
