...
#if !(defined linux || defined NETWARE_386 || defined WIN_NT || defined OS2_ONLY || defined mpexl || defined FREEBSD || defined NETBSD || defined DARWIN)
...
#ifndef  SUPERSERVER
#if defined(SCO_EV) || defined(LINUX) || defined(FREEBSD) || defined(NETBSD) || defined(AIX_PPC) || defined(DARWIN) || defined(SINIXZ) || defined(HPUX)
